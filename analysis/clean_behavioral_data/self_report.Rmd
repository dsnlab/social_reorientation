...
key_list = list(academic = c("-Q1", "-Q7", "Q13", "Q19", "-Q25", "Q31"),
                ...
                self_worth = c("Q6", "Q12", "-Q18", "-Q24", "-Q30", "Q36"))

sppc[39:41] = psych::scoreItems(key_list, sppc[,-c(1:2)], min = 1, max = 4)$scores
...
sppc = sppc %>%
  ...
  gather(domain, competence, academic, social, self_worth)
```
