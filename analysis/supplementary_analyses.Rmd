...
if (file.exists("../data/model_domain_dummy_pdss_2021.RDS")) {
  model_domain = readRDS("../data/model_domain_dummy_pdss_2021.RDS")
} else {
  ...
  saveRDS(model_domain, "../data/model_domain_dummy_pdss_2021.RDS")
}
...
if (file.exists("../data/model_target_dummy_pdss_2021.RDS")) {
  model_target = readRDS("../data/model_target_dummy_pdss_2021.RDS")
} else {
  ...
  saveRDS(model_target, "../data/model_target_dummy_pdss_2021.RDS")
}
